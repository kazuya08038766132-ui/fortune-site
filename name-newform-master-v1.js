...
"田":5,"山":3,"川":3,"中":4,"大":3,"本":5,"一":1,"生":5,"翔":12,"藤":18,"郎":9,"松":8,"和":8,"也":3
});
function lookup(c){return Number.isInteger(D[c])?{char:c,strokes:D[c],standard:"NEW_FORM",source:"NEW_FORM_AUDITED_SEED_V2_KANJIPEDIA"}:null}
...
window.NameNewFormMaster={version:"NEW_FORM_AUDITED_SEED_V2",lookup,split};
})();